...
public class RollTheDice {
     ...
     * 또한, 어떠한 경우에서도 주어진 기능을 구현했을 때, 오류가 발생해서는 안됩니다.
     * <p>
    ...
    private static void fillArray(double result) {
        int divided = (int) (result / 60); // 60으로 나눈 몫을 계산
        if (divided >= frequency.length) { // 배열의 크기를 초과하는 경우 배열 확장
            frequency = extendArray(divided + 1);
        }
        frequency[divided]++; // 해당 인덱스의 값 증가
    }
